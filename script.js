...
const mobileNavWrapper = document.querySelector(".nav");
const navLinks = document.querySelector(".nav__links");
const navMenuIcon = document.querySelector(".nav__menu-icon");
const navMenuCloseIcon = document.querySelector(".nav__menu-close-icon");
...
// Mobile menu
const openMenu = () => {
  console.log('mobileNavWrapper', mobileNavWrapper);
  mobileNavWrapper.classList.add('active');
  navLinks.classList.add('active');
  navMenuIcon.classList.remove('active');
  navMenuCloseIcon.classList.add('active');
...
const closeMenu = () => {
  ...
  navMenuIcon.classList.add('active');
  navMenuCloseIcon.classList.remove('active');
...
navMenuCloseIcon.addEventListener('click', closeMenu);
